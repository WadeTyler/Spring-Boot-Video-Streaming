package net.tylerwade.localexample;
...
public class VideoController {
	...
	// A bean of LocalContentStreamAdapter is auto configured.
	...
	@GetMapping("/{key}")
	public ResponseEntity<StreamingResponseBody> getVideoContent(@PathVariable String key,
